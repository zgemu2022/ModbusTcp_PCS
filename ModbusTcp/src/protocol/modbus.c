...
unsigned short pqpcs_pw_set[]={0x3005,0x3015,0x3025,0x3035,0x3065,0x3075};//恒功率模式 功率给定设置0.1kW正为放电，负为充电
unsigned short pqpcs_cur_set[]={0x3004,0x3014,0x3024,0x3034,0x3064,0x3074};//恒流模式 电流给定设置0.1A正为放电，负为充电
